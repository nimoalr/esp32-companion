...
const voice_gesture_t k_voice_gestures[VOICE_COUNT] = {
    [VOICE_HAPPY]     = { "happy",     420, 3, P({ 0.f, 0.f }, { 0.45f, 4.f }, { 1.f, 9.f }),     6.f, 0.3f, 0, 0,      0.05f, 0.35f, 2.f,  12, 60,  0, 2800, 0.8f, false },
    [VOICE_LAUGH]     = { "laugh",     620, 3, P({ 0.f, 2.f }, { 0.5f, 5.f }, { 1.f, 3.f }),      6.f, 0.4f, 0, 0,      0.10f, 0.30f, 2.f,  5,  40,  5, 2600, 0.8f, false },
    [VOICE_SAD]       = { "sad",       700, 3, P({ 0.f, 3.f }, { 0.3f, 1.f }, { 1.f, -7.f }),     5.f, 0.5f, 0, 0,      0.12f, 0.25f, 1.5f, 40, 120, 0, 1800, 0.7f, false },
    [VOICE_SURPRISED] = { "surprised", 320, 3, P({ 0.f, -2.f }, { 0.6f, 8.f }, { 1.f, 14.f }),    0,   0,    0, 0,      0.06f, 0.30f, 2.f,  8,  60,  0, 3200, 0.9f, false },
    [VOICE_SCARED]    = { "scared",    520, 3, P({ 0.f, 4.f }, { 0.4f, 12.f }, { 1.f, 13.f }),    0,   0,    22.f, 2.f, 0.10f, 0.25f, 2.f,  8,  80,  0, 3400, 0.9f, false },
    [VOICE_ANGRY]     = { "angry",     600, 3, P({ 0.f, -10.f }, { 0.5f, -9.f }, { 1.f, -12.f }), 0,   0,    38.f, 1.f, 0.25f, 0.50f, 1.5f, 15, 80,  0, 1500, 0.9f, false },
    [VOICE_ANNOYED]   = { "annoyed",   380, 3, P({ 0.f, -6.f }, { 0.5f, -5.f }, { 1.f, -9.f }),   0,   0,    30.f, 1.f, 0.20f, 0.40f, 1.5f, 20, 60,  2, 1700, 0.8f, false },
    [VOICE_YAWN]      = { "yawn",      1100, 4, P({ 0.f, -2.f }, { 0.3f, 3.f }, { 0.6f, 1.f }, { 1.f, -9.f }), 4.f, 0.6f, 0, 0, 0.25f, 0.20f, 2.f, 120, 250, 0, 1600, 0.7f, false },
    [VOICE_PURR]      = { "purr",      1000, 2, P({ 0.f, -14.f }, { 1.f, -13.f }),                0,   0,    26.f, 0.f, 0.30f, 0.40f, 2.f,  150, 250, 0, 900,  0.7f, true },
    [VOICE_HM]        = { "hm",        380, 3, P({ 0.f, -1.f }, { 0.6f, 0.f }, { 1.f, 6.f }),     0,   0,    0, 0,      0.15f, 0.20f, 2.f,  30, 60,  0, 1400, 0.7f, false },
    [VOICE_CONFUSED]  = { "confused",  640, 4, P({ 0.f, -1.f }, { 0.4f, 5.f }, { 0.55f, -2.f }, { 1.f, 7.f }), 0, 0, 0, 0, 0.15f, 0.20f, 2.f, 30, 60, 2, 1500, 0.7f, false },
    [VOICE_DIZZY]     = { "dizzy",     900, 3, P({ 0.f, 4.f }, { 0.5f, 0.f }, { 1.f, -6.f }),     7.f, 2.5f, 0, 0,      0.08f, 0.30f, 1.5f, 40, 150, 0, 2200, 0.8f, false },
    [VOICE_PROTEST]   = { "protest",   560, 4, P({ 0.f, 6.f }, { 0.3f, 10.f }, { 0.6f, 5.f }, { 1.f, 11.f }), 0, 0, 0, 0, 0.08f, 0.30f, 2.f, 5, 30, 4, 3000, 0.9f, false },
    [VOICE_KO]        = { "ko",        900, 3, P({ 0.f, 6.f }, { 0.4f, -2.f }, { 1.f, -16.f }),   3.f, 0.4f, 0, 0,      0.10f, 0.25f, 2.f,  10, 300, 0, 1800, 0.8f, false },
    [VOICE_OH]        = { "oh",        300, 3, P({ 0.f, 1.f }, { 0.5f, 5.f }, { 1.f, 3.f }),      0,   0,    0, 0,      0.08f, 0.25f, 2.f,  15, 80,  0, 2000, 0.7f, false },
    [VOICE_BLIP]      = { "blip",      90,  2, P({ 0.f, 10.f }, { 1.f, 13.f }),                   0,   0,    0, 0,      0.f,   0.20f, 2.f,  3,  25,  0, 3800, 0.6f, false },
    [VOICE_WAKE]      = { "wake",      700, 3, P({ 0.f, -5.f }, { 0.7f, -1.f }, { 1.f, 4.f }),    4.f, 0.4f, 0, 0,      0.15f, 0.25f, 2.f,  150, 120, 0, 1600, 0.6f, false },
};
#undef P
