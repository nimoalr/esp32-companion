...
| Efficient music calibration with local HTML coordination | Music Lab records labeled feature references over USB, about 90 KB/minute, with markers/export/import and a plain-C report tool. It does not automatically train or tune firmware thresholds. Further tuning is pending the planned recordings. |
