...
int main(int argc,char **argv)
{
 ...
 if(csv)fprintf(csv,"time_ms,beat,kick,raw_loud,bpm,confidence,ratio,speech,kick_raw,bass_raw,mid_raw,high_raw,would_dance,would_listen\n");
