...
int main(void)
{
    ...
    const char *labels[]={"LASERS","SPOTLIGHTS","BOTH / SPECTRUM","BOTH / DISCO"};
    for(int i=0;i<4;i++) {
        ...
        s->sm.dance_visual=i<2?0:i-1;s->sm.dance_visual_ms=0;s->sm.dance_visual_len=100000;
        s->sm.dance_lasers_on=i!=1;s->sm.dance_laser_len=100000;
        s->sm.dance_spots_on=i!=0;s->sm.dance_spot_len=100000;
    }
