...
export function createReplay(onEdit,notice){
 ...
 audio.onerror=()=>{if(audition){audition=null;stems.resetSolo();notice("This browser could not decode the embedded FLAC stem. Your original recording and saved stems are unchanged.");preview();}};
