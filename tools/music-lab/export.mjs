...
for(const [i,t] of meta.tracks.entries()){
 ...
 fs.writeFileSync(stem+'.json',JSON.stringify({...t,timebase:'seconds from first captured frame; sequence gaps retained as silence',sampleRate:16000,channels:2,pcmStats:stats,gaps:map.gaps,evaluation:evaluate(map,t.annotations||[])},null,2),{flag:'wx'});
